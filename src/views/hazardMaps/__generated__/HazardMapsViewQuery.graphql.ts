/**
 * @generated SignedSource<<c04705de237a004ab81a8504aa5c9d76>>
      ...
      },
      {
        ...
        "selections": [
          ...
          },
          {
            ...
            "kind": "ScalarField",
            "name": "geojson",
            "storageKey": "geojson(color_scale:\"inferno\",color_scale_vmax:2,fill_opacity:0.5,stroke_opacity:0.5,stroke_width:0.1)"
          }
        ],
        "storageKey": null
      }
...
return {
  ...
  "params": {
    "cacheID": "21a72cf6e1b4af496190fc9c3d517330",
    "id": null,
    "metadata": {},
    "name": "HazardMapsViewQuery",
    "operationKind": "query",
    "text": "query HazardMapsViewQuery(\n  $grid_id: RegionGrid\n  $hazard_model_ids: [String]\n  $imts: [String]\n  $aggs: [String]\n  $vs30s: [Float]\n  $poes: [Float]\n) {\n  gridded_hazard(grid_id: $grid_id, hazard_model_ids: $hazard_model_ids, imts: $imts, aggs: $aggs, vs30s: $vs30s, poes: $poes) {\n    ok\n    gridded_hazard {\n      grid_id\n      hazard_model\n      imt\n      agg\n      values\n      geojson(color_scale: \"inferno\", color_scale_vmax: 2, fill_opacity: 0.5, stroke_width: 0.1, stroke_opacity: 0.5)\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "e4ef79b38e7718ee689a2446be4a06ce";
