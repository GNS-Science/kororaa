...
const MultiRuptureMapControls: React.FC<MultiRuptureMapControlsProps> = ({
  startTransition,
  isPending,
  dispatch,
  geoJsonError,
}: MultiRuptureMapControlsProps) => {
  ...
  const data = useLazyLoadQuery<MultiRuptureMapPageControlsQuery>(multiRuptureMapPageControlsQuery, {
