...
const DisclaimerLayer: React.FC<DisclaimerLayerProps> = ({ children }: DisclaimerLayerProps) => {
  const currentDisclaimerVersion = import.meta.env.VITE_DISCLAIMER_VERSION as string;
  ...
  return (
    <>
      <StyledModal
        ...
        aria-describedby="modal-modal-description modal-modal-description2"
      >
        <Paper>
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            This output has been prepared by the Institute of Geological and Nuclear Sciences Limited (GNS Science). GNS
            Science accepts no responsibility for any use of or reliance on any contents of this output by any person,
