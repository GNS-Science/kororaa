              ...
              <Grid item xs={12}>
                <StyledCard>
                  <CardContent>
                    ...
                    <Typography>
                      Led by Hugh Cowan, the purpose of the Assurance and Lessons Review is to support the uptake of the
                      new National Seismic Hazard Model into policy and practice, and to inform how future iterations of
                      the Model and its development may ensure best practice. It provides assurance to decision-makers
                      that the processes followed for development of the revised NSHM facilitated reasonable and
                      legitimate scientific review, and led to best practice science and a rational consensus model.
                    </Typography>
                  </CardContent>
                </StyledCard>
              </Grid>
