export const IFMControlsMockData = {
  nzshm_model: {
    model: {
      version: "NSHM_1.0.0",
            ...
            branches: [
              {
                ...
                values: [
                  ...
                  {
                    long_name: "time dependent",
                    json_value: "false",
                  },
                  {
                    long_name: "bN pair",
                    json_value: "[0.823, 2.7]",
                  },
                  {
                    long_name: "area-magnitude scaling",
                    json_value: "4.2",
          ...
          },
          {
            ...
            branches: [
              ...
              },
              {
                name: "bN",
                long_name: "bN pair",
                value_options: "[[0.95, 16.5], [1.097, 21.5], [1.241, 27.9]]",
              },
              {
                name: "C",
                long_name: "area-magnitude scaling",
            ...
            branches: [
              {
                name: "dm",
                long_name: "deformation model",
                value_options: '["geodetic", "geologic"]',
              },
              {
                name: "td",
                long_name: "time dependent",
              ...
              },
              {
                name: "bN",
                long_name: "bN pair",
                value_options: "[[0.823, 2.7], [0.959, 3.4], [1.089, 4.6]]",
              },
              {
                name: "C",
                long_name: "area-magnitude scaling",
