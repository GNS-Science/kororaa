...
- Use `HAZARD_MODEL_VERSION=NSHM_v1.0.4`
...
- update GHA scripts; update Franz Josef location; use env for HAZARD_MODEL_VERSION; [`ca9b338`](https://github.com/GNS-Science/kororaa/commit/ca9b3385ac8f2537daebdd117dce0b8db89a848c)
