...
module.exports = override((config) => {
  ...
  const terserConfigIdx = config.optimization.minimizer.findIndex((opt) => opt && opt.constructor && opt.constructor.name === 'TerserPlugin');
  if (terserConfigIdx > -1) {
    updatedConfig.optimization.minimizer[terserConfigIdx].options.terserOptions.keep_classnames = true;
